...
const BOOL_KEYS = ['reminder_enabled', 'auto_stay_signed_in', 'auto_return_to_app', 'session_keepalive_enabled', 'hide_ace_code', 'hide_work_type', 'show_project_label', 'show_delproj_summary', 'show_semester_summary', 'arbetstimmar_collapsed_default', 'debug_logging'];
